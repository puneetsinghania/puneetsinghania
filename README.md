...
<p align="center">
  <img src="https://skillicons.dev/icons?i=java,spring,kafka,redis,mysql,postgres,python,cpp,docker,kubernetes,git,github,jenkins,azure,grafana,linux,maven,gradle,idea,vscode,postman&perline=11" alt="Technology matrix" />
</p>
